...
class PASScoreController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('pas.show', $score->id))
    ...
    { 
        ...
        $type = "PAS";
        return view('Admin.Scores.pas',compact('type','score'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $score->save();
        return redirect(route('pas.show', $scores))
