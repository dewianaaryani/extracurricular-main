...
@section('breadcrumb')
    ...
    <div class="breadcrumb-item">Update Siswa</div>
@endsection
@section('content')
                @if($errors->any())
      ...
      <div class="card-body">
          <div class="row">
            <div class="form-group col-8">
              ...
              <input id="name" type="text" class="form-control" name="name" value="{{$siswa -> name}}" autofocus>
            </div>
            <div class="form-group col-4">
              <label for="nip">NIS</label>
              <input id="nomor_induk" type="text" class="form-control" name="nomor_induk" value="{{$siswa -> nomor_induk}}">
            </div>
          </div>      
          <div class="row">
            <div class="form-group col-6">
              <label for="username">Username</label>
              <input id="username" type="username" class="form-control" name="username" value="{{$siswa -> username}}">
              <div class="invalid-feedback">
              </div>
            </div>
            <div class="form-group col-6">
              <label for="password" class="d-block">Password</label>
              <input id="password" type="password" class="form-control pwstrength" data-indicator="pwindicator" name="password" value="{{$siswa -> password}}">                      
            </div>                    
          </div>
          <div class="row">
            <div class="form-group col-6">
