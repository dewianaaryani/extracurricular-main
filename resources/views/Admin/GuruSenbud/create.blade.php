...
@section('breadcrumb')
                ...
                <div class="breadcrumb-item active"><a href="{{route('gurusenbud.index')}}">Guru Senbud</a></div>              
              <div class="breadcrumb-item">Add Guru Senbud</div>
@endsection
@section('content')
...
<div class="row">
  <div class="col-12">
<form method="post" action="{{route('gurusenbud.store')}}" enctype="multipart/form-data" class="">
@csrf
