...
<div class="row">
  <div class="col-12">
     ...
     <form method="post" action="{{route('daily.update', $score->id)}}" enctype="multipart/form-data" class="">
            @csrf
            @method('PUT')
            <div class="card card-primary">      
                <div class="card-header"><h4>Nilai {{$type}}</h4>
                    <div class="card-header-action">
                        <a class="btn btn-success" href="{{route('daily.show',$score->score_id)}}">Back</a>  
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
