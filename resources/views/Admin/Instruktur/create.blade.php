...
@section('breadcrumb')
                ...
                <div class="breadcrumb-item active"><a href="{{route('instruktur.index')}}">Instruktur UPD</a></div>              
              <div class="breadcrumb-item">Add Instruktur UPD</div>
@endsection
@section('content')
...
<div class="row">
  <div class="col-12">
<form method="post" action="{{route('instruktur.store')}}" enctype="multipart/form-data" class="">
@csrf
